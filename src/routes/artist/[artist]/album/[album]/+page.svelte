<script>
    ...
    const res = await fetch(`http://ws.audioscrobbler.com/2.0/?method=album.getinfo&artist=${$page.params.artist}&album=${$page.params.album}&api_key=a616b292b50e4f5ecb60671554c2965d&format=json
`);
